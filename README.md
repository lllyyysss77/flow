...
> 本仓库用于FlowDeer Tree在线版的托管，独立部署版的下载
...
- [YouTube教程](https://youtu.be/vz1xBKzLAVM)
- [B站教程](https://www.bilibili.com/video/BV1xP411Y7ak/)
...
1. 下载本仓库代码
2. `docs` 目录下为独立部署版代码，可复制到支持静态网页的服务器或对象存储
3. 注意服务器需要支持WASM文件
